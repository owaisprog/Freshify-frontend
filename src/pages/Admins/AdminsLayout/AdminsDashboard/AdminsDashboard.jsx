    ...
    <main className="pt-20 lg:pt-0 min-h-screen">
      ...
      {hasData && (
        <section className="max-w-[1440px] mx-auto ">
          {/* First Section  */}
          <section className="  flex flex-col justify-between w-full lg:flex-row gap-8 lg:gap-6  p-6">
          ...
          <section className="  flex flex-col  justify-between lg:flex-row gap-8  lg:gap-6  p-6">
          ...
          {/* Third Section  */}
          <section className="   flex justify-between flex-col w-full  lg:flex-row gap-8 lg:gap-6  p-6">
            {/* Sales and Top performer section  */}
            <section className="   lg:w-full flex flex-col gap-[10px] lg:max-w-[470px]">
              {/* Sales Section  */}
              <section className=" ">
